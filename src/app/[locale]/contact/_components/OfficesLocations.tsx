    ...
    <div className="bg-white pt-3 pb-24 sm:pb-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 text-base/7 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {offices.map((office) => (
            <div key={office.id}>
              <h3 className="ltr:border-l rtl:border-r border-primary ltr:pl-6 rtl:pr-6 font-semibold text-gray-900">
                {office.name}
              </h3>
              <address className="ltr:border-l rtl:border-r border-gray-200 rtl:pr-6 ltr:pl-6 pt-2 not-italic">
