...
export default function ContactSection() {
    return (
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
          ...
          <form action="#" method="POST" className="px-6 pb-24 pt-20 sm:pb-32 lg:px-8 lg:py-32">
            <div className="mx-auto max-w-xl lg:mr-0 lg:max-w-lg bg-white p-12 rounded-2xl border">
