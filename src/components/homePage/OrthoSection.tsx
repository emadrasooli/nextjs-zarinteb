                ...
                <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10 px-6 py-10 md:px-10 md:py-14">
                  ...
                  ZO
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
                            <div className="flex items-center gap-2 rounded-xl bg-white/70 border border-emerald-100 px-4 py-3 backdrop-blur-sm">
                  ...
                  Manufactured by ZarinTeb
                        ...
                        <div className="pt-2">
                            <Link
                                href="/products"
                                className="inline-flex items-center justify-center rounded-2xl bg-teal-600 px-6 py-3 text-sm font-semibold text-white shadow-lg shadow-teal-500/20 transition-all duration-300 hover:bg-teal-700 hover:shadow-xl hover:shadow-teal-500/30"
                            >
