    ...
    <header className="bg-white border-b border-zinc-100 shadow-sm shadow-zinc-100">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-3 lg:px-8 px-4">
        ...
        <PopoverGroup className="hidden lg:flex lg:gap-x-6">
          <Link href='/' className="text-sm/6 font-medium text-zinc-900 hover:bg-slate-100 px-2 py-1 rounded-md">
            {t('home')} 
          </Link>
          <Link href='/about' className="text-sm/6 font-medium text-zinc-900 hover:bg-slate-100 px-2 py-1 rounded-md">
            {t('about')}
          </Link>
          ...
          <Link href='/service' className="text-sm/6 font-medium text-gray-900 hover:bg-slate-100 px-2 py-1 rounded-md">
            {t('service')}
          </Link>
          <Link href='/contact' className="text-sm/6 font-medium text-gray-900 hover:bg-slate-100 px-2 py-1 rounded-md">
            {t('contact')}
          </Link>
        </PopoverGroup>
